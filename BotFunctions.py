...
def accept_trade():
    ...
    print("I found Locked In and now " 
          "I should find Lock in button and click it ")
    lockIn = check('./Screens\LockinFullHD.png', 1498, 521, 1887, 617)
    click(lockIn[0], lockIn[1])
    print("I clicked Lock in button and now I'm looking when trade is confirmed.")
    check('./Screens\ConfirmedFullHD.png', 1350, 694, 1500, 800)
    print("I found Confirmed and now " 
          "I should find Trade button and click it ")
