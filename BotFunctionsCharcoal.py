...
def put_all_items_asmo():
    ...
    #put tolvium
    flux = check('.\Screens\TolviumFullHD.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
    click(Split[0], Split[1])
    time.sleep(.1)
    inTrade = check('.\Screens\inTradeFullHD.png', 962, 74, 1403, 984)
    double_click(inTrade[0], inTrade[1])
    time.sleep(.1)
    put_item_in_trade(1,0,'.\Screens\ReadyForTradeFullHD.png')
    ...
    #put cinnabar
    flux = check('.\Screens\CinnabarFullHD.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
    ...
    double_click(inTrade[0], inTrade[1])
    time.sleep(.1)
    put_item_in_trade(1,0,r'.\Screens\ReadyForTradeFullHD.png')

    #put charcoal
    flux = check(r'.\Screens\CharcoalFullHD.png', 962, 165, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check(r'.\Screens\SplitFullHD.png', 962, 165, 1403, 984)
    time.sleep(.1)
    click(Split[0], Split[1])
    time.sleep(.1)
    inTrade = check(r'.\Screens\inTradeFullHD.png', 962, 165, 1403, 984)
    time.sleep(.1)
    double_click(inTrade[0], inTrade[1])
    time.sleep(.1)
    put_item_in_trade_flux_and_charcoal(3, 0, 0, r'.\Screens\ReadyForTradeFullHD.png')

    #put ingot
    flux = check('.\Screens\IngotFullHD.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
    ...
    double_click(inTrade[0], inTrade[1])
    time.sleep(.1)
    put_item_in_trade(5,0,'.\Screens\ReadyForTradeFullHD.png')
...
def put_all_items_asmo_plus_runic():
    ...
    #put scarhide
    flux = check('.\Screens\scarhide_full_hd.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
    ...
    #put smolderhide
    flux = check('.\Screens\smolderhide_full_hd.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
    ...
    #put infused leather
    flux = check('.\Screens\infused_leather_full_hd.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
...
def put_all_items_asmo_plus_runic_plus_phoenix():
    ...
    #put blisterweave
    flux = check('.\Screens\listerweave_full_hd.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
    ...
    #put scalecloth
    flux = check('.\Screens\scalecloth_full_hd.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
    ...
    #put unfused silk
    flux = check('.\Screens\infused_silk_full_hd.png', 962, 74, 1403, 984)
    time.sleep(.1)
    click(flux[0], flux[1])
    time.sleep(.1)
    Split = check('.\Screens\SplitFullHD.png', 962, 74, 1403, 984)
...
def accept_trade():
    ...
    check('.\Screens\LockedInFullHD.png', 1350, 694, 1500, 800)
    lockIn = check('.\Screens\LockinFullHD.png', 1498, 521, 1887, 617)
    click(lockIn[0], lockIn[1])
    check('.\Screens\ConfirmedFullHD.png', 1350, 694, 1500, 800)
    Trade = check('.\Screens\TradeFullHD.png', 1498, 521, 1887, 617)
...
def full_rotation(server, names_asmo, names_asmo_plus_runic, names_asmo_plus_runic_plus_phoenix, names_asmo_plus_phoenix):
    ...
    while 1:
        ...
        if num == 1 and second_trade_check(a, second_trade) == 1: 
           ...
           file_update(a)
           a = list(set(a) - set(z))
           step('.\Screens\stepFullHD.png', 1238, 23, 1765, 216)
